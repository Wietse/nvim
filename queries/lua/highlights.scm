...
; Operators
; NOTE: Patched for Neovim 0.12.0 — the bundled Lua parser lacks the
; "operator" field that the bundled query references. Use explicit tokens
; instead. Remove this file once a fixed Neovim release is available.
[
  "+"
  "-"
  "*"
